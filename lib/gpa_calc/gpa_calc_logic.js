...
function credits(year) {
    var totCreditsIncludedInGpa = global_gpa.totalCreditsOfYearInGpa(year);
    var totCredits = global_gpa.totalCreditsOfYear(year);
...
function updateCreditsInTables() {
  ...
  for (var i = 1; i <= 4; ++i) {
      ...
      sumCreditsIncludedInGpa += global_gpa.totalCreditsOfYearInGpa(i);
      sumAllCredits += global_gpa.totalCreditsOfYear(i);
  }
...
function finalOverallGPA() {
    ...
    for (var i = 1; i <= 4; ++i) {
        sumCredits += global_gpa.totalCreditsOfYearInGpa(i);
...
function overallGPA(year) {
    var sumCredits = global_gpa.totalCreditsOfYearInGpa(year);
