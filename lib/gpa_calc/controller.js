...
function removeSubject(object) {
    ...
    var subjectCode = object.getElementsByTagName('TD')[2].innerHTML;
    global_student.removeSubject(subjectCode);
    ...
    notify("<em>Remove (Subject):</em> " + object.getElementsByTagName('TD')[1].innerHTML);
}
