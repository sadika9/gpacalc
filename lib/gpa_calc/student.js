...
Student.prototype.setIncludeInOverallGpa = function(courseCode, state) {
    this.getCourseRef(courseCode).include_in_overall_gpa = state;
}

Student.prototype.setIncludeInSubjectGpa = function(courseCode, subjectCode, includeSubject) {
    var eC = this.getCourseRef(courseCode);
